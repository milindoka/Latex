...
\begin{tikzpicture}
    ...
    \draw (-1,4) -- node[below,sloped] {\tiny$x_1+x_2\geqslant 3$} (5,-2);
    \draw (1,-3) -- (3,1) -- node[below left,sloped] {\tiny$2x_1-x_2\leqslant 5$} (4.5,4);
    \draw (-1,1) -- node[above,sloped] {\tiny$-x_1+2x_2\leqslant 3$} (5,4);
